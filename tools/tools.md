...
### PowerShell Scripts
- **FileLocator** — `powershell/FileLocator/find_file.ps1`  
...
### CrowdStrike Queries
- **Quick Suspicious DNS Hunting CQL queries** — `cql/cqlSuspiciousDnsHunting.cql`  
...
### Python Scripts
- **WebSleuth** — `python/curl_scrapper.py`  
